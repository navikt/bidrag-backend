...
class PrivatAvtaleControllerTest : AbstractControllerTest() {
    ...
    inner class BarnUnder18 {
        ...
        private fun lagGyldigPrivatAvtaleBarnUnder18RequestDto(): PrivatAvtaleBarnUnder18RequestDto = PrivatAvtaleBarnUnder18RequestDto(
            språk = Språkkode.NB,
    ...
    inner class BarnOver18 {
        ...
        fun `skal generere privat avtale PDF for barn over 18`() {
            ...
            postRequest(
                ...
                .andExpect(
                    header().string(
                        "Content-Disposition",
                        "inline; filename=\"privatavtale.pdf\"",
                    ),
                )
        ...
        private fun lagGyldigPrivatAvtaleBarnOver18RequestDto(): PrivatAvtaleBarnOver18RequestDto = PrivatAvtaleBarnOver18RequestDto(
            språk = Språkkode.NB,
            bidragstype = BidragsType.MOTTAKER,
            bidragsmottaker = PrivatAvtalePart(
                "Ola",
