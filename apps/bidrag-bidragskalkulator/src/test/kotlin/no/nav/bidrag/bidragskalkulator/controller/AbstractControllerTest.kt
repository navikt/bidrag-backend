...
abstract class AbstractControllerTest {
    ...
    protected fun postRequest(url: String, body: Any, token: String? = null): ResultActions = mockMvc.perform(buildJsonRequest(post(url), body, token))

    protected fun getRequest(url: String, token: String? = null): ResultActions = mockMvc.perform(buildJsonRequest(get(url), null, token))
