...
class BidragGrunnlagConsumer(
    ...
    private val grunnlagUri by lazy {
    ...
    fun hentGrunnlag(ident: String, antallAar: Int = HENT_INNTEKT_ANTALL_ÅR_DEFAULT): HentGrunnlagDto = medApplikasjonsKontekst {
        try {
            val (output, varighet) = measureTimedValue {
                postForNonNullEntity<HentGrunnlagDto>(
                    grunnlagUri,
