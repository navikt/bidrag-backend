...
class BidragPersonConsumer(
    ...
    private val hentFamilierelasjonUri by lazy {
    ...
    private val hentPersonUri by lazy {
        UriComponentsBuilder
            .fromUri(URI.create(bidragPersonConfig.url))
    ...
    private inline fun <reified T : Any> postSafely(uri: URI, request: Any, ident: Personident): T = try {
