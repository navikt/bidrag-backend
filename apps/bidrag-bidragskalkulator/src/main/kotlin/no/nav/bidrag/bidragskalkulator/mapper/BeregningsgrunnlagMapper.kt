...
class BeregningsgrunnlagMapper(
    ...
    private fun byggGrunnlag(referanse: String, type: Grunnlagstype, fødselsdato: LocalDate? = null): GrunnlagDto = beregningsgrunnlagBuilder.byggPersongrunnlag(referanse, type, fødselsdato)
