...
fun PersonDto.tilPersonInformasjonDto(): PersonInformasjonDto = PersonInformasjonDto(
    ident = this.ident,
...
fun PersonDto.tilBarnInformasjonDto(underholdskostnad: BigDecimal?): BarnInformasjonDto = BarnInformasjonDto(
    ident = this.ident,
    fornavn = this.fornavn ?: "",
    fulltNavn = this.visningsnavn,
...
fun PersonDto.tilPrivatAvtaleInformasjonDto(): PrivatAvtaleInformasjonDto = PrivatAvtaleInformasjonDto(
    ident = this.ident,
    fornavn = this.fornavn ?: "-",
    etternavn = this.etternavn ?: "-",
)

fun PersonDto.erLevendeOgIkkeSkjermet(): Boolean = !this.erDød() && !harFortroligAdresse()

fun PersonDto.erDød(): Boolean = this.dødsdato != null

fun PersonDto.harFortroligAdresse(): Boolean = this.diskresjonskode in FORTROLIG_ADRESSE_DISKRESJONSKODER
