...
data class PrivatAvtalePart(
    ...
    @param:Schema(
        description = "Partens personnummer eller d-nummer (11 siffer)",
        required = true,
    )
...
data class Oppgjør(
    ...
    @param:Schema(
        description = "Oppgjørsform i dag",
        ref = "#/components/schemas/Oppgjørsform",
    )
...
data class PrivatAvtaleBarnOver18RequestDto(
    ...
    @param:Schema(
        description = "Opplysninger om oppgjør av barnebidrag, inkludert om avtalen er ny eller en endring, " +
            "nåværende oppgjørsform og ønsket oppgjørsform.",
        required = true,
    )
    @field:NotNull
    @field:Valid
