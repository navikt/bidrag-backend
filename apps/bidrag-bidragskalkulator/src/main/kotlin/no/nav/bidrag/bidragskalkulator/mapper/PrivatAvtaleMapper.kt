...
fun PrivatAvtalePdf.tilGenererFørstesideRequestDto(
    innsenderIdent: Personident,
...
fun PrivatAvtaleBarnUnder18RequestDto.normalisert(): PrivatAvtaleBarnUnder18RequestDto = copy(
    barn = barn
        .asSequence()
        .sortedBy { it.fraDato }
...
fun PrivatAvtaleBarnOver18RequestDto.normalisert(): PrivatAvtaleBarnOver18RequestDto = copy(
