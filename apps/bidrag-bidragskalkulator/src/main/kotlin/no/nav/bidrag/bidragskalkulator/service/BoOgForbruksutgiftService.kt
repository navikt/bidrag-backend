...
@Service
class BoOgForbruksutgiftService(
    ...
    fun genererBoOgForbruksutgiftstabell(): Map<Int, BigDecimal> {
    ...
    fun beregnCachedPersonBoOgForbruksutgiftskostnad(alder: Int): BigDecimal {
