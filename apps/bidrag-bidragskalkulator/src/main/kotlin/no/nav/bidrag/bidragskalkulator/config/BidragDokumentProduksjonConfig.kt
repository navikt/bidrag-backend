...
class DokumentProduksjonConfiguration {
    ...
    ): BidragDokumentProduksjonConsumer = BidragDokumentProduksjonConsumer(properties, restTemplate, dokumentProduksjonHeader())

    @Bean("PrivatAvtalePdfProsessor")
    fun providePdfProsessor(): PrivatAvtalePdfProsessor = PrivatAvtalePdfProsessor()
