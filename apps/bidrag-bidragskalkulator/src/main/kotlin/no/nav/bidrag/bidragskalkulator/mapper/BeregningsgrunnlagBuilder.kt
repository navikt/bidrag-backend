...
class BeregningsgrunnlagBuilder(
    ...
    fun byggBostatusgrunnlag(data: BeregningKontekst): List<GrunnlagDto> {
        fun nyttBostatusgrunnlag(referanse: String, bostatus: Bostatuskode, gjelderBarnReferanse: String?, gjelderReferanse: String? = null) = GrunnlagDto(
            referanse = referanse,
    ...
    fun byggInntektsgrunnlag(data: BeregningKontekst): List<GrunnlagDto> {
        ...
        fun nyttInntektsgrunnlag(referanse: String, beløp: BigDecimal, eierReferanse: String) = GrunnlagDto(
            referanse = referanse,
    ...
    fun byggBarnInntektsgrunnlag(barn: IFellesBarnDto, referanse: String): GrunnlagDto? = barn.inntekt?.let { beløp ->
        GrunnlagDto(
    ...
    fun byggSamværsgrunnlag(samværsklasse: Samværsklasse, gjelderBarnReferanse: String): GrunnlagDto = GrunnlagDto(
