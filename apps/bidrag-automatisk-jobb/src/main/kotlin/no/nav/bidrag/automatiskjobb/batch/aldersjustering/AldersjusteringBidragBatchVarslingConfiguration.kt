...
class AldersjusteringBidragBatchVarslingConfiguration {
    ...
    fun aldersjusteringBidragBatchKategori(
        ...
        @Value($$"${ALDERSJUSTERING_BIDRAG_LAGRE_B4_CRON:-}") lagreB4Cron: String,
        @Value($$"${ALDERSJUSTERING_BIDRAG_OPPRETT_FORSENDELSE_CRON:-}") opprettForsendelseCron: String,
        @Value($$"${ALDERSJUSTERING_BIDRAG_DISTRIBUER_FORSENDELSE_CRON:-}") distribuerForsendelseCron: String,
        ...
        listOf(
            ...
            Batch("Lagre B4-informasjon for aldersjustering bidrag", lagreB4Cron),
