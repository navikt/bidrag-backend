...
@DisplayName("MaksFradragController")
class MaksFradragControllerTest {
  ...
  @Test
  @DisplayName("skal hente maksfradrag sjabloner")
  void skalHenteMaksFradragSjabloner() {

    var listeResponse =
        restTemplate.exchange(
            "http://localhost:" + port + "/bidrag-sjablon/maksfradrag",
            HttpMethod.GET,
            null,
            List.class);
