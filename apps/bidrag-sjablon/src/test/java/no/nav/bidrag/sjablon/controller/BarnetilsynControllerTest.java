...
@DisplayName("BarnetilsynController")
class BarnetilsynControllerTest {
  ...
  @Test
  @DisplayName("skal hente barnetilsyn sjabloner")
  void skalHenteBarnetilsynSjabloner() {

    var listeResponse =
        restTemplate.exchange(
            "http://localhost:" + port + "/bidrag-sjablon/barnetilsyn",
            HttpMethod.GET,
            null,
            List.class);
