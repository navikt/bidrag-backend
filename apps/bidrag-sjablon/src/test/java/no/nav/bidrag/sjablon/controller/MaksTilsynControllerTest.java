...
@DisplayName("MaksTilsynController")
class MaksTilsynControllerTest {
  ...
  @Test
  @DisplayName("skal hente makstilsyn sjabloner")
  void skalHenteMaksTilsynSjabloner() {

    var listeResponse =
        restTemplate.exchange(
            "http://localhost:" + port + "/bidrag-sjablon/makstilsyn",
            HttpMethod.GET,
            null,
            List.class);
