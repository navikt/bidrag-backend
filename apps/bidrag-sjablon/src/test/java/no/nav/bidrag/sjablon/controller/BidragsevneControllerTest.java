...
@DisplayName("BidragsevneController")
class BidragsevneControllerTest {
  ...
  @Test
  @DisplayName("skal hente bidragsevne sjabloner")
  void skalHenteBidragsevneSjabloner() {

    var listeResponse =
        restTemplate.exchange(
            "http://localhost:" + port + "/bidrag-sjablon/bidragsevner",
            HttpMethod.GET,
            null,
            List.class);
