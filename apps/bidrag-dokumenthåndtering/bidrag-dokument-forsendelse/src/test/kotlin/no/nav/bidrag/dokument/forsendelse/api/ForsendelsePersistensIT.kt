...
class ForsendelsePersistensIT : KontrollerTestContainerRunner() {
    ...
    fun `Skal opprette forsendelse med behandlinginfo`() {
        val barn1Ident = genererFødselsnummer()
        val barn2Ident = genererFødselsnummer()
        val opprettForsendelseForespørsel =
            nyOpprettForsendelseForespørsel().copy(
                ...
                BehandlingInfoDto(
                    ...
                    barnIBehandling = listOf(barn1Ident, barn2Ident),
                ),
            )
        ...
        await.atMost(Duration.ofSeconds(2)).untilAsserted {
            ...
            behandlingInfo.barnIBehandling shouldContain barn1Ident
            behandlingInfo.barnIBehandling shouldContain barn2Ident
        }
        ...
        journalpost.behandlingInfo!!.barnIBehandling!! shouldContainAnyOf listOf(barn1Ident, barn2Ident)
    }
    ...
    fun `Skal oppdatere og endre rekkefølge på dokumentene i forsendelse`() {
        val forsendelse =
            testDataManager.opprettOgLagreForsendelse {
                ...
                +nyttDokument(journalpostId = "BID-123123213", dokumentreferanseOriginal = "BIF1231232", rekkefølgeIndeks = 2)
            }
    ...
    fun `skal distribuere forsendelse med kontrollerte og redigerte dokumenter`() {
        ...
        val nyJournalpostId = "2131333123"
