...
class OppdaterDistribusjonStatusTest : KafkaHendelseTestRunner() {
    ...
    private fun opprettForsendelseFerdigstiltIkkeDistribuert(): Forsendelse = testDataManager.lagreForsendelse(
        opprettForsendelse2(
    ...
    private fun opprettForsendelseUnderProduksjon(): Forsendelse = testDataManager.lagreForsendelse(
        opprettForsendelse2(
    ...
    private fun opprettForsendelseDistribuert(): Forsendelse = testDataManager.lagreForsendelse(
        opprettForsendelse2(
