...
class RedigerForsendelseKontrollerTest : KontrollerTestRunner() {
    ...
    fun `Skal hente dokument redigeringmetadata hvis ikke finnes fra før`() {
        ...
        val dokumentreferanse2 = "BIF4412421"
        val forsendelse =
    ...
    fun utførLagreRedigeringmetadata(
        ...
        nyMetadata: String,
    ): ResponseEntity<DokumentRedigeringMetadataResponsDto> = httpHeaderTestRestTemplate.exchange<DokumentRedigeringMetadataResponsDto>(
    ...
    fun utførHentRedigeringmetadata(
        forsendelseId: String,
        dokumentreferanse: String,
    ): ResponseEntity<DokumentRedigeringMetadataResponsDto> = httpHeaderTestRestTemplate.getForEntity<DokumentRedigeringMetadataResponsDto>(
        "${rootUri()}/redigering/$forsendelseId/$dokumentreferanse",
    )
}
