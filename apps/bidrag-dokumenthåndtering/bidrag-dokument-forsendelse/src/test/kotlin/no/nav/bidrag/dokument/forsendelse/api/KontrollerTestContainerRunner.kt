...
abstract class KontrollerTestContainerRunner : TestContainerRunner() {
    ...
    protected fun utførDistribuerForsendelse(
        ...
        batchId: String? = null,
    ): ResponseEntity<DistribuerJournalpostResponse> = httpHeaderTestRestTemplate.postForEntity<DistribuerJournalpostResponse>(
    ...
    ): ResponseEntity<DokumentRespons> = httpHeaderTestRestTemplate.exchange<DokumentRespons>(
    ...
    fun utførHentDokumentMetadata(
        forsendelseId: String,
        dokumentreferanse: String,
    ): ResponseEntity<List<DokumentMetadata>> = httpHeaderTestRestTemplate.exchange(
