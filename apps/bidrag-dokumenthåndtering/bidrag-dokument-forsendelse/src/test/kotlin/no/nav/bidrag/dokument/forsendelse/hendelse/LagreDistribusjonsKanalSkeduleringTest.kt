...
class LagreDistribusjonsKanalSkeduleringTest : TestContainerRunner() {
    ...
    private fun opprettIkkeDistribuertForsendelse(): Forsendelse = testDataManager.lagreForsendelse(
        opprettForsendelse2(
    ...
    ): Forsendelse = testDataManager.lagreForsendelseNotNewTransaction(
        opprettForsendelse2(
