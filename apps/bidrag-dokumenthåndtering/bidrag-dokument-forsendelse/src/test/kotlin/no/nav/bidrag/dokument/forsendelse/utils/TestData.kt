...
val GJELDER_IDENT = genererFødselsnummer()
...
val NY_JOURNALPOSTID = "1231231231"

fun jsonToString(data: Any): String = try {
...
fun opprettDokumentMetadataListe(journalpostId: String): List<DokumentMetadata> = listOf(
    opprettDokumentMetadata(journalpostId),
)

fun opprettBehandlingDto(): BehandlingDto = BehandlingDto(
...
fun opprettVedtakDto(): VedtakDto = VedtakDto(
...
fun opprettSak(): BidragssakDto = BidragssakDto(
