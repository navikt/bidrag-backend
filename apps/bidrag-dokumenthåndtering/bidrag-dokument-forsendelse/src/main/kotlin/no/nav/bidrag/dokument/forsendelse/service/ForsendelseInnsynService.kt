...
class ForsendelseInnsynService(
    ...
    private fun tilDokumenterMetadata(dokumenter: List<Dokument>): Map<String, DokumentDtoMetadata> = dokumenter.associate {
    ...
    fun hentDokumentvalgForsendelse(forsendelseId: Long): Map<String, DokumentMalDetaljer> = hentDokumentvalgForsendelseV2(forsendelseId).dokumentMalDetaljer
}
