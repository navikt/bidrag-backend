...
class DistribusjonService(
    ...
    fun harDistribuert(forsendelse: Forsendelse): Boolean = forsendelse.status == ForsendelseStatus.DISTRIBUERT || forsendelse.status == ForsendelseStatus.DISTRIBUERT_LOKALT
