...
fun OppdaterForsendelseForespørsel.skalDokumentSlettes(dokumentreferanse: String): Boolean = this.dokumenter.find { it.dokumentreferanse == dokumentreferanse }?.fjernTilknytning == true
...
fun Forsendelse.erBatchForsendelseIkkeDistribuertEldreEnn3Dager(): Boolean = batchId != null &&
