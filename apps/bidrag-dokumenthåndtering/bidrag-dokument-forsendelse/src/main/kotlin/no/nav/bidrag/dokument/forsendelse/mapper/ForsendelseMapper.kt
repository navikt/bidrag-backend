...
fun Dokument.tilOpprettDokumentForespørsel() = OpprettDokumentForespørsel(
    tittel = tittel,
    dokumentreferanse = dokumentreferanse,
...
fun Mottaker.hentAdresse(): Adresse? = if (SamhandlerId(ident ?: "").gyldig()) {
...
fun Ettersendingsoppgave.tilEttersendingsoppaveDto() = EttersendingsoppgaveDto(
    tittel = tittel,
