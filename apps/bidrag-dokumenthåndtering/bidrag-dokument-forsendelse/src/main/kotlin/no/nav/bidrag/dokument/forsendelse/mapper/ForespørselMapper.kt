...
object ForespørselMapper {
    ...
    fun PersonIdent.tilIdentType() = if (this.erSamhandler()) {
    ...
    fun OpprettDokumentForespørsel.tilArkivsystemDo(): DokumentArkivSystem = if (this.journalpostId?.erForsendelse == true) {
    ...
    fun OpprettDokumentForespørsel.erBestillingAvNyttDokument() = this.journalpostId.isNullOrEmpty() && this.dokumentreferanse.isNullOrEmpty() && this.dokumentmalId.isNotNullOrEmpty()
