...
open class Ettersendingsoppgave(
    ...
    override fun toString(): String = "Ettersendingsoppgave(id=$id, forsendelse=${forsendelse.forsendelseId}, tittel=$tittel, ettersendelseForJournalpostId=$ettersendelseForJournalpostId, innsendelsesId=$innsendingsId, skjemaId=$skjemaId)"
}
