...
fun distribusjonFeilet(forsendelseId: Long): Nothing = throw HttpClientErrorException(
...
fun forsendelseHarIngenBehandlingInfo(forsendelseId: Long): Nothing = throw HttpClientErrorException(
    HttpStatus.BAD_REQUEST,
...
fun ugyldigAvviksForespørsel(melding: String): Nothing = throw HttpClientErrorException(
    HttpStatus.BAD_REQUEST,
