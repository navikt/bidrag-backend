...
class GcpCloudStorage(
    ...
    fun totalStørrelse(forsendelseId: Long): Long = try {
        storage
    ...
    private fun createObjectUploadPrecondition(blobInfo: BlobInfo): Storage.BlobWriteOption = if (storage.get(blobInfo.blobId) == null) {
