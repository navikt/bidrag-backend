...
class BidragDokumentJournalpostConsumer(
    ...
    fun oppdaterStatusPåDokumentUnderProduksjon(): OppdaterStatusPåDokumenterUnderProduksjonResultDto = postForNonNullEntity<OppdaterStatusPåDokumenterUnderProduksjonResultDto>(
