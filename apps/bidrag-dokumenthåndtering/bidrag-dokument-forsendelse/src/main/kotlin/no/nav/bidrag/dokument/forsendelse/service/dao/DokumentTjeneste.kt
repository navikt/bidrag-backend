...
class DokumentTjeneste(
    ...
    fun hentDokumenterMedReferanse(dokumentreferanse: String): List<Dokument> = dokumentRepository.hentDokumenterMedDokumentreferanse(dokumentreferanse, dokumentreferanse.utenPrefiks.toLong())
    ...
    ): List<Dokument> = dokumentRepository.hentDokumentIkkeFerdigstiltFørDato(
