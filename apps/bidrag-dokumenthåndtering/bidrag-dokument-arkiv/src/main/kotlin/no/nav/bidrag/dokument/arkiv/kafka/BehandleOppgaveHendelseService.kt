...
class BehandleOppgaveHendelseService(
    ...
    private fun opprettKommentarSomLeggesTilReturlogg(journalpost: Journalpost): String = if (journalpost.harReturKommetFraNavNo()) "Distribusjon feilet, mottaker mangler postadresse" else "Returpost"
}
