...
class AvvikService(
    ...
    fun behandleAvvik(journalpost: Journalpost, avvikshendelseIntern: AvvikshendelseIntern): BehandleAvvikshendelseResponse {
        ...
        SECURE_LOGGER.info {
            "Avvik ${avvikshendelseIntern.avvikstype} ble utført på journalpost ${avvikshendelseIntern.journalpostId} av bruker " +
                "${saksbehandlerInfoManager.hentSaksbehandlerBrukerId()} og enhet ${avvikshendelseIntern.saksbehandlersEnhet} " +
                "med beskrivelse ${avvikshendelseIntern.beskrivelse} - avvik $avvikshendelseIntern"
        }
    ...
    fun kopierFraAnnenFagomrade(journalpost: Journalpost, avvikshendelseIntern: AvvikshendelseIntern) {
        ...
        LOGGER.info("Kopiert journalpost ${journalpost.journalpostId} til Bidrag, ny journalpostId $journalpostId")
