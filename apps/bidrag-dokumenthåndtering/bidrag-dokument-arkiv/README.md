...
* Lytt på oppgave-opprettet og Joark journalføring
  hendelser [HendelseListener](src/main/kotlin/no/nav/bidrag/dokument/arkiv/kafka/HendelseListener.kt)
...
Start opp applikasjon ved å kjøre BidragDokumentArkivLocal.kt under test/kotlin mappen.
...
Kjør
filen [BidragDokumentArkivLokalNais](src/test/kotlin/no/nav/bidrag/dokument/arkiv/BidragDokumentArkivLokalNais.kt)
