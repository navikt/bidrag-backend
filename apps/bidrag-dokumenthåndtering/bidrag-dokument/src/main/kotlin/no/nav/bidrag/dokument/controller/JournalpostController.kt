...
fun JournalpostDto.erFarskapUtelukketEllerBidragJournalpostMedTemaFar() = this.erFarskapUtelukket() // || JournalpostId(this.journalpostId).erSystemBidrag && fagomrade == "FAR"
