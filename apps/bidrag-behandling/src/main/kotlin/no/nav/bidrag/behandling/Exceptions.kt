...
fun samværIkkeFunnet(
    behandlingId: Long,
    gjelderBarn: String,
): Nothing = throw HttpClientErrorException(
...
fun behandlingNotFoundException(behandlingId: Long): Nothing = throw HttpClientErrorException(
    HttpStatus.NOT_FOUND,
    "Fant ikke behandling med id $behandlingId",
)

fun aktiveringAvGrunnlagFeiletException(behandlingsid: Long): Nothing = throw HttpClientErrorException(
    HttpStatus.INTERNAL_SERVER_ERROR,
    "Aktivering av grunnlag feilet for behandling $behandlingsid",
)

fun inntektIkkeFunnetException(idInntekt: Long): Nothing = throw HttpClientErrorException(HttpStatus.NOT_FOUND, "Fant ikke inntekt med id $idInntekt")
...
fun ressursIkkeFunnetException(feilmelding: String): Nothing = throw HttpClientErrorException(
    HttpStatus.NOT_FOUND,
    feilmelding,
)

fun ressursIkkeTilknyttetBehandling(feilmelding: String): Nothing = throw HttpClientErrorException(
...
fun oppdateringAvBoforholdFeiletException(behandlingsid: Long): Nothing = throw HttpClientErrorException(
    HttpStatus.INTERNAL_SERVER_ERROR,
    "Oppdatering av boforhold feilet for behandling $behandlingsid",
)

fun oppdateringAvInntektFeilet(melding: String): Nothing = throw HttpClientErrorException(
    HttpStatus.BAD_REQUEST,
    melding,
)

fun oppdateringAvBoforholdFeilet(melding: String): Nothing = throw HttpClientErrorException(
    HttpStatus.BAD_REQUEST,
    melding,
)
...
fun lagringAvGrunnlagFeiletException(behandlingsid: Long): Nothing = throw HttpClientErrorException(
    HttpStatus.INTERNAL_SERVER_ERROR,
    "Lagring av grunnlag feilet for behandling $behandlingsid",
)

fun aktiveringAvGrunnlagstypeIkkeStøttetException(behandlingsid: Long): Nothing = throw HttpClientErrorException(
    HttpStatus.BAD_REQUEST,
    "Feil grunnlagstype oppgitt i aktiveringsforespørsel for behandling $behandlingsid",
)

fun finnesFraFørException(behandlingsid: Long): Nothing = throw HttpClientErrorException(
    HttpStatus.CONFLICT,
...
fun fantIkkeFødselsdatoTilPerson(behandlingsid: Long): Nothing = throw HttpClientErrorException(
    HttpStatus.INTERNAL_SERVER_ERROR,
    "Fant ikke fødselsdato til person i behandling med id $behandlingsid",
)

fun fantIkkeFødselsdatoTilSøknadsbarn(behandlingsid: Long): Nothing = throw HttpClientErrorException(
    HttpStatus.INTERNAL_SERVER_ERROR,
    "Fant ikke fødselsdato til søknadsbarn i behandling med id $behandlingsid",
)

fun rolleManglerFødselsdato(rolletype: Rolletype): Nothing = throw HttpClientErrorException(
    HttpStatus.BAD_REQUEST,
    "Rolle med type $rolletype mangler fødselsdato",
)

fun vedtakmappingFeilet(melding: String): Nothing = throw HttpClientErrorException(
    HttpStatus.BAD_REQUEST,
    melding,
)
