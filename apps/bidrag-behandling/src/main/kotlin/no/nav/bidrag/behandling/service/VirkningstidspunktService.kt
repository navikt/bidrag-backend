...
import no.nav.bidrag.behandling.transformers.vedtak.finnStønadsendringNyesteIdent
...
class VirkningstidspunktService(
    ...
    @Lazy private val forholdsmessigFordelingService: ForholdsmessigFordelingService,
) {
    ...
    private fun hentPerioderVedtak(
        ...
        val stønadsendring = vedtak.finnStønadsendringNyesteIdent(stønadsid)
    ...
    fun oppdatereVirkningstidspunkt(
        ...
        .let {
            ...
            forholdsmessigFordelingService.synkroniserSøknadsbarnOgRevurderingsbarnForFFBehandling(it, ignorerSynkTimer = true)
            it
        }
