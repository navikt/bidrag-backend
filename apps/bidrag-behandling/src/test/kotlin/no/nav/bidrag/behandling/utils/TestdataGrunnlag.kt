...
fun opprettArbeidsforholdGrunnlagListe() = listOf(
...
fun opprettAinntektGrunnlagListe() = listOf(
    AinntektGrunnlagDto(
...
fun opprettSkattegrunnlagGrunnlagListe() = listOf(
...
fun opprettUtvidetBarnetrygdGrunnlagListe() = listOf(
...
fun opprettSmåbarnstillegListe() = listOf(
...
fun opprettBarnetilleggListe() = listOf(
...
fun opprettKontantstøtteListe() = listOf(
...
fun opprettBarnetilsynListe() = listOf(
