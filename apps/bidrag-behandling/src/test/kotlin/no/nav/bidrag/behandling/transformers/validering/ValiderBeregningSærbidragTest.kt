...
class ValiderBeregningSærbidragTest {
    ...
    @Test
    fun `skal validere behandling`(): Unit = validering.run {
    ...
    @Test
    fun `skal validere behandling hvis avslag`(): Unit = validering.run {
        val behandling = opprettGyldigBehandling()
    ...
    @Test
    fun `skal feile validering hvis utgift ikke er satt`(): Unit = validering.run {
        val behandling = opprettGyldigBehandling()
        behandling.utgift = Utgift(behandling)
    ...
    @Test
    fun `skal feile validering hvis utgift har ugyldig utgiftspost`(): Unit = validering.run {
        val behandling = opprettGyldigBehandling()
        behandling.utgift =
            Utgift(
                behandling,
    ...
    @Test
    fun `skal feile validering hvis utgift maks godkjent beløp ikke er satt`(): Unit = validering.run {
        val behandling = opprettGyldigBehandling()
    ...
    @Test
    fun `skal feile validering hvis utgift maks godkjent beløp begrunnelse ikke er satt`(): Unit = validering.run {
        val behandling = opprettGyldigBehandling()
        behandling.utgift!!.maksGodkjentBeløpTaMed = true
    ...
    @Test
    fun `skal ikke feile validering hvis utgift maks godkjent beløp ikke er tatt med`(): Unit = validering.run {
        val behandling = opprettGyldigBehandling()
    ...
    @Test
    fun `skal feile validering hvis mangler bosstatusperiode for søknasdbarn`(): Unit = validering.run {
        val behandling = opprettGyldigBehandling()
    ...
    @Test
    fun `skal feile validering hvis mangler bosstatus for andre voksne i husstanden`(): Unit = validering.run {
        val behandling = opprettGyldigBehandling()
        behandling.husstandsmedlem =
            mutableSetOf(
                opprettHusstandsmedlem(
    ...
    @Test
    fun `skal feile validering hvis andre voksne i husstanden har tom liste med perioder`(): Unit = validering.run {
        val behandling = opprettGyldigBehandling()
        behandling.husstandsmedlem =
            mutableSetOf(
                opprettHusstandsmedlem(
    ...
    @Test
    fun `skal feile validering hvis BP mangler inntekter`(): Unit = validering.run {
        val behandling = opprettGyldigBehandling()
    ...
    @Test
    fun `skal feile validering hvis BM mangler inntekter`(): Unit = validering.run {
        val behandling = opprettGyldigBehandling()
        behandling.inntekter =
            mutableSetOf(
                opprettInntekt(
    ...
    inner class ValideringTekniskSærbidrag {
        ...
        @Test
        fun `skal feile hvis engangsbeløptype ikke er SÆRBIDRAG`(): Unit = validering.run {
            val behandling = opprettGyldigBehandling()
        ...
        @Test
        fun `skal feile hvis flere enn en søknasdbarn`(): Unit = validering.run {
            val behandling = opprettGyldigBehandling()
        ...
        @Test
        fun `skal feile hvis virkningstidspunkt ikke er lik inneværende måned`(): Unit = validering.run {
            val behandling = opprettGyldigBehandling()
        ...
        @Test
        fun `skal feile hvis kategori ANNET ikke har beskrivelse`(): Unit = validering.run {
            val behandling = opprettGyldigBehandling()
