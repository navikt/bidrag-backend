...
Applikasjonen er en modul i monorepoet `bidrag-backend`. Kommandoene kjøres fra rotmappen til monorepoet.

bygge og teste modulen (inkludert moduler den avhenger av)
> mvn -pl apps/bidrag-behandling -am verify

###### Ktlint
verifisere
> mvn -pl apps/bidrag-behandling antrun:run@ktlint

formattere
> mvn -pl apps/bidrag-behandling antrun:run@ktlint-format
...
Åpne terminal i mappen `apps/bidrag-behandling`
