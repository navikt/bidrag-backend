...
class CacheEvictBeforeWorkingHours : Expiry<Any, Any> {
    ...
    override fun expireAfterUpdate(o1: Any, o2: Any, currentTime: Long, currentDuration: Long): Long = currentDuration

    override fun expireAfterRead(p0: Any, p1: Any, currentTime: Long, currentDuration: Long): Long = currentDuration
}
