...
public class MapperTest {
    ...
    private static final Testperson HOVEDPART = new Testperson("Pegasus", 35);
    private static final Testperson MOTPART = new Testperson("Zuez", 43);
    private static final Testperson BARN_OVER_FEMTEN = new Testperson("Alfa", 16);
    private static final Testperson BARN_UNDER_FEMTEN = new Testperson("Beta", 12);
    private static final Testperson BARN_OVER_ATTEN = new Testperson("Myndig", 18);
    ...
    void skalIkkeInkludereBarnDersomMotpartManglerPersonident() {
        ...
        // gitt
        var testperson = HOVEDPART;
        var ukjentMotpart = new Testperson(null, 50, true);
