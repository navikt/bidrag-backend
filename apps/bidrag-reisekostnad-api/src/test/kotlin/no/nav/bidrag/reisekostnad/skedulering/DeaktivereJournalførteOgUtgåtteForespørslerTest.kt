...
class DeaktivereJournalførteOgUtgåtteForespørslerTest : DatabehandlerTest() {
    ...
    fun skalSletteSamtykkeoppgaveSelvOmVarslingAvForeldreFeiler() {
        ...
        forespørselMedFeilOgUtløptSamtykkefrist.barn = mutableSetOf(testpersonBarn11, testpersonBarn15Nr2)
        forespørselMedFeilOgUtløptSamtykkefrist.hovedpart.personident = genererFødselsnummer()
