...
class BarnFylt15årTest : DatabehandlerTest() {
    ...
    fun skalOppdatereForespørselHvisInneholderFlereBarnSomHarFylt15år() {
        // gitt
        var originalForespørsel = opppretteForespørsel(true)
        originalForespørsel.barn = mutableSetOf(testpersonBarn15, testpersonBarn15Nr3)
    ...
    fun skalRulleTilbakeEndringerVedFeil() {
        ...
        forespørselMedFeil.barn = mutableSetOf(testpersonBarn11, testpersonBarn15Nr2)
        ...
        forespørselMedEttBarn.barn = mutableSetOf(testpersonBarn15Nr3)
