...
enum class Grunnlagstype {
    ...
    @Deprecated(
        "Bruk DELBEREGNING_INDEKSREGULERING_PRIVAT_AVTALE i stedet",
        replaceWith = ReplaceWith("DELBEREGNING_INDEKSREGULERING_PRIVAT_AVTALE"),
    )
    ...
    ETTERFØLGENDE_MANUELLE_VEDTAK,

    // Barnebidrag - flere barn - sluttberegning
