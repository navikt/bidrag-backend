...
enum class Behandlingstema(
    ...
    companion object {
        fun fraKode(kode: String): Behandlingstema? = try {
...
fun Stønadstype.tilBehandlingstema(): Behandlingstema = when (this) {
...
fun Behandlingstema.tilStønadstype(): Stønadstype? = when (this) {
...
fun Behandlingstema.tilBeskrivelse(medInnkreving: Boolean = false): String? = when (this) {
