...
open class SecurityTokenService(
    ...
    open fun stsAuthTokenInterceptor(): ClientHttpRequestInterceptor? = ClientHttpRequestInterceptor { request: HttpRequest, body: ByteArray?, execution: ClientHttpRequestExecution ->
    ...
    open fun serviceUserAuthTokenInterceptor(clientRegistrationId: String? = null): ClientHttpRequestInterceptor? = clientCredentialsTokenInterceptor(clientRegistrationId)

    open fun clientCredentialsTokenInterceptor(clientRegistrationId: String? = null): ClientHttpRequestInterceptor? = ClientHttpRequestInterceptor { request: HttpRequest, body: ByteArray?, execution: ClientHttpRequestExecution ->
    ...
    open fun authTokenInterceptor(clientRegistrationId: String): ClientHttpRequestInterceptor = ClientHttpRequestInterceptor { request: HttpRequest, body: ByteArray?, execution: ClientHttpRequestExecution ->
    ...
    ): ClientHttpRequestInterceptor? = ClientHttpRequestInterceptor { request: HttpRequest, body: ByteArray?, execution: ClientHttpRequestExecution ->
    ...
    open fun navConsumerTokenInterceptor(ignoreWhenIncomingSTS: Boolean = false): ClientHttpRequestInterceptor? = ClientHttpRequestInterceptor { request: HttpRequest, body: ByteArray?, execution: ClientHttpRequestExecution ->
