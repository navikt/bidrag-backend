...
data class EndringSjekkGrensePeriodePeriodeGrunnlagV2(
    ...
    val beløpshistorikkBidragPeriodeGrunnlag: BeløpshistorikkPeriodeGrunnlag?,
    val privatAvtaleIndeksregulertPeriodeGrunnlagListe: List<PrivatAvtaleIndeksregulertPeriodeGrunnlagV2>,
    val sjablonSjablontallPeriodeGrunnlagListe: List<SjablonSjablontallPeriodeGrunnlag>,
)
...
data class PrivatAvtaleIndeksregulertPeriodeGrunnlagV2(
    val referanse: String,
    val privatAvtaleIndeksregulertPeriode: DelberegningIndeksreguleringPrivatAvtale,
)
