...
import no.nav.bidrag.beregn.barnebidrag.utils.finnPersonGrunnlag
...
internal object AldersjusteringMapper : CoreMapper() {
    ...
    fun mapAldersjusteringGrunnlagFraVedtak(
        ...
        // Finn søknadsbarn fra grunnlag mtp at referanse kan være ulik utifra det som sendes fra beregningen
        val søknadsbarnFraGrunnlag = grunnlagListeFraVedtak.toList().finnPersonGrunnlag(søknadsbarn.ident, søknadsbarn.fødselsdato)
        ...
        val sluttberegning = hentSluttberegningFraGrunnlag(
            ...
            vedtakId = vedtak.vedtakId,
            søknadsbarnReferanse = søknadsbarnFraGrunnlag?.referanse ?: søknadsbarn.referanse,
        )
