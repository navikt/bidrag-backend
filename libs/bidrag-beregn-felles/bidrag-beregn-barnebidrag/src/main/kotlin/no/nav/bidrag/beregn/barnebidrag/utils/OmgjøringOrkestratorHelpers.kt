...
import no.nav.bidrag.beregn.barnebidrag.service.beregning.BeregnIndeksreguleringPrivatAvtaleService.delberegningIndeksreguleringPrivatAvtale
        ...
        return if (delberegningIndeksreguleringPrivatAvtalePeriodeResultat.isNotEmpty()) {
            ...
            beløpshistorikk.copy(
                nesteIndeksreguleringsår = maxOf(
                    ...
                    privatavtalePerioder.firstOrNull()?.nesteIndeksreguleringsår?.toInt() ?: 0,
                ).takeIf { it != 0 },
