...
class BeregnAldersjusteringService : BeregnService() {
    ...
    fun beregnAldersjusteringBarnebidrag(mottattGrunnlag: BeregnGrunnlagAldersjustering): BeregnetBarnebidragResultat {
        secureLogger.debug {
            "Beregning av aldersjustering barnebidrag - følgende request mottatt: ${
        ...
        val identBidragspliktig = mottattGrunnlag.personObjektListe.bidragspliktig?.personObjekt?.ident ?: "Ukjent bidragspliktig"
        val identBidragsmottaker = mottattGrunnlag.personObjektListe.bidragsmottaker?.personObjekt?.ident ?: "Ukjent bidragsmottaker"
        ...
        søknadsbarnGrunnlagListe.forEach { søknadsbarn ->
            ...
            // Sjekker om beregnet beløp er lavere enn løpende beløp fra beløpshistorikken. I så fall skal det logges.
            if (erAldersjustertBeløpLavereEnnEllerLikLøpendeBeløp(
                ...
                secureLogger.info {
                    "Beregning av aldersjustering barnebidrag - beregnet beløp er lavere enn løpende bidrag for bp: " +
                        "$identBidragspliktig, bidragsmottaker: $identBidragsmottaker, barn : ${søknadsbarn.ident}"
                }
            }
        }
        ...
        secureLogger.debug {
            "Beregning av aldersjustering barnebidrag - følgende respons returnert: ${
                commonObjectmapper.writeValueAsString(
