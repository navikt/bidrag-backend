...
internal object NettoBarnetilleggBeregning {
    ...
    fun beregn(grunnlag: NettoBarnetilleggBeregningGrunnlag): NettoBarnetilleggBeregningResultat {
        ...
        val summertBruttoBarnetillegg = barnetilleggTypeListe.sumOf { it.bruttoBarnetillegg }
        val summertNettoBarnetillegg = barnetilleggTypeListe.sumOf { it.nettoBarnetillegg }
        ...
        return NettoBarnetilleggBeregningResultat(
            ...
            grunnlagsreferanseListe = grunnlag.barnetilleggBeregningGrunnlagListe.map { it.referanse },
        )
    }
}
