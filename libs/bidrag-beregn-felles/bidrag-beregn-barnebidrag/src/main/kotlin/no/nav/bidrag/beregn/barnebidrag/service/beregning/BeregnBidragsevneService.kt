...
internal object BeregnBidragsevneService : BeregnService() {
    ...
    fun delberegningBidragsevne(
        ...
        return slåSammenLikeObjekter(
            ...
            grunnlagstype = Grunnlagstype.DELBEREGNING_BIDRAGSEVNE,
            utvidPeriodeTil = ::utvidBidragsevnePeriodeTil,
        )
    }

    // Spesifikk implementasjon for å utvide periode for DelberegningBidragsevne. Slår sammen fra-periode fra forrige objekt og til-periode fra
    // nåværende objekt og beholder resten av innholdet fra forrige objekt.
    private fun utvidBidragsevnePeriodeTil(forrigeGrunnlag: GrunnlagDto, nåværendeGrunnlag: GrunnlagDto): GrunnlagDto {
        val forrigeBidragsevne = forrigeGrunnlag.tilInnholdMedReferanse<DelberegningBidragsevne>()
        val nåværendeBidragsevne = nåværendeGrunnlag.tilInnholdMedReferanse<DelberegningBidragsevne>()

        val utvidetPeriode = forrigeBidragsevne.innhold.periode.copy(
            til = nåværendeBidragsevne.innhold.periode.til,
        )
        val utvidetInnhold = forrigeBidragsevne.innhold.copy(periode = utvidetPeriode)
