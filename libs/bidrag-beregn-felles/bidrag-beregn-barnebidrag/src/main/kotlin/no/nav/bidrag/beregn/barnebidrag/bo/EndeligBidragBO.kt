...
data class SumBidragTilFordelingPeriodeGrunnlag(
    ...
    val bidragTilFordelingPrivatAvtaleDelberegningPeriodeGrunnlagListe: List<BidragTilFordelingPrivatAvtaleDelberegningPeriodeGrunnlag>,
)
...
data class SumBidragTilFordelingBeregningGrunnlag(
    ...
    val bidragTilFordelingPrivatAvtaleBeregningGrunnlagListe: List<BidragTilFordelingPrivatAvtaleDelberegningBeregningGrunnlag>,
)
...
data class SumBidragTilFordelingDelberegningBeregningGrunnlag(
    val referanse: String,
    val sumBidragTilFordeling: BigDecimal,
    val sumPrioriterteBidragTilFordeling: BigDecimal,
)
...
data class BidragTilFordelingLøpendeBidragPeriodeGrunnlag(
    ...
    val samværsfradragDelberegningPeriodeGrunnlagListe: List<SamværsfradragDelberegningPeriodeGrunnlag>,
    val valutakursGrunnlag: ValutakursGrunnlagTilBeregning?,
)
...
data class BidragTilFordelingLøpendeBidragBeregningGrunnlag(
    ...
    val samværsfradragBeregningGrunnlag: SamværsfradragDelberegningBeregningGrunnlag?,
    val valutakursBeregningGrunnlag: ValutakursGrunnlagTilBeregning?,
)
...
data class BidragTilFordelingLøpendeBidragBeregningResultat(
    ...
    val bidragTilFordeling: BigDecimal,
    val bidragTilFordelingNOK: BigDecimal,
    val erNorskBidrag: Boolean,
    val erOppfostringsbidrag: Boolean,
    val grunnlagsreferanseListe: List<String> = emptyList(),
)
...
data class BidragTilFordelingLøpendeBidragDelberegningBeregningGrunnlag(
    val referanse: String,
    val bidragTilFordeling: BigDecimal,
    val erNorskBidrag: Boolean,
    val erOppfostringsbidrag: Boolean,
...
data class BidragTilFordelingPrivatAvtalePeriodeGrunnlag(
    val beregningsperiode: ÅrMånedsperiode,
    val privatAvtaleGrunnlag: PrivatAvtaleGrunnlagTilBeregning,
    val indeksreguleringPrivatAvtalePeriodeGrunnlagListe: List<IndeksreguleringPrivatAvtaleDelberegningPeriodeGrunnlag>,
    val samværsfradragDelberegningPeriodeGrunnlagListe: List<SamværsfradragDelberegningPeriodeGrunnlag>,
    val valutakursGrunnlag: ValutakursGrunnlagTilBeregning?,
)

data class BidragTilFordelingPrivatAvtalePeriodeResultat(val periode: ÅrMånedsperiode, val resultat: BidragTilFordelingPrivatAvtaleBeregningResultat)

data class BidragTilFordelingPrivatAvtaleBeregningGrunnlag(
    val privatAvtaleBeregningGrunnlag: PrivatAvtaleGrunnlagTilBeregning,
    val indeksreguleringPrivatAvtaleBeregningGrunnlag: IndeksreguleringPrivatAvtaleDelberegningBeregningGrunnlag,
    val samværsfradragBeregningGrunnlag: SamværsfradragDelberegningBeregningGrunnlag?,
    val valutakursBeregningGrunnlag: ValutakursGrunnlagTilBeregning?,
)

data class BidragTilFordelingPrivatAvtaleBeregningResultat(
    val valutakode: Valutakode,
...
data class BidragTilFordelingPrivatAvtaleDelberegningPeriodeGrunnlag(
    val referanse: String,
    val bidragTilFordelingPrivatAvtalePeriode: DelberegningBidragTilFordelingPrivatAvtale,
)

data class BidragTilFordelingPrivatAvtaleDelberegningBeregningGrunnlag(
    val referanse: String,
    val bidragTilFordeling: BigDecimal,
    val erNorskBidrag: Boolean,
)

data class IndeksreguleringPrivatAvtaleDelberegningPeriodeGrunnlag(
    val referanse: String,
    val privatAvtalePeriode: DelberegningIndeksreguleringPrivatAvtale,
)

data class IndeksreguleringPrivatAvtaleDelberegningBeregningGrunnlag(
    val referanse: String,
    val indeksregulertBeløp: BigDecimal,
    val valutakode: Valutakode,
)
...
data class ValutakursGrunnlagTilBeregning(val referanse: String, val valutakursListe: List<ValutaPar>)

data class PrivatAvtaleGrunnlagTilBeregning(val referanse: String, val sakskategori: Sakskategori)
