...
internal class BeregnBarnebidragTest : FellesTest() {
    ...
    fun testBarnebidrag_Eksempel02() {
        ...
        // Resultat
        forventetEndeligResultatbeløp = BigDecimal.valueOf(3070).setScale(0)
        ...
        // Endelig bidrag
        forventetBeregnetBeløp = BigDecimal.valueOf(3071.00).setScale(2)
        forventetResultatbeløp = BigDecimal.valueOf(3070).setScale(0)
        forventetUMinusNettoBarnetilleggBM = BigDecimal.valueOf(3071.00).setScale(2)
        forventetBruttoBidragEtterBarnetilleggBM = BigDecimal.valueOf(3327.00).setScale(2)
        forventetNettoBidragEtterBarnetilleggBM = BigDecimal.valueOf(3071.00).setScale(2)
        forventetBruttoBidragJustertForEvneOg25Prosent = BigDecimal.valueOf(3327.00).setScale(2)
        forventetBruttoBidragEtterBegrensetRevurdering = BigDecimal.valueOf(3327.00).setScale(2)
        forventetBruttoBidragEtterBarnetilleggBP = BigDecimal.valueOf(3327.00).setScale(2)
        forventetNettoBidragEtterSamværsfradrag = BigDecimal.valueOf(3071.00).setScale(2)
        forventetBpAndelAvUVedDeltBostedFaktor = BigDecimal.ZERO.setScale(10)
        forventetBpAndelAvUVedDeltBostedBeløp = BigDecimal.ZERO.setScale(2)
        forventetBidragJustertForNettoBarnetilleggBM = true
    ...
    fun testBarnebidrag_Eksempel08A() {
        ...
        assertAll(
            ...
            { assertThat(barnebidragResultat.beregnetBarnebidragPeriodeListe[0].grunnlagsreferanseListe).contains("delberegning_DELBEREGNING_PRIVAT_AVTALE_Person_Bidragspliktig_Person_Søknadsbarn_202408") },
            {
            ...
            { assertThat(barnebidragResultat.beregnetBarnebidragPeriodeListe[1].grunnlagsreferanseListe).contains("delberegning_DELBEREGNING_PRIVAT_AVTALE_Person_Bidragspliktig_Person_Søknadsbarn_202408") },
    ...
    fun testBarnebidrag_Eksempel08D() {
        ...
        assertAll(
            ...
            {
                assertThat(barnebidragResultat.beregnetBarnebidragPeriodeListe[0].grunnlagsreferanseListe)
                    .contains("delberegning_DELBEREGNING_PRIVAT_AVTALE_Person_Bidragspliktig_Person_Søknadsbarn_202101")
            },
            {
                assertThat(barnebidragResultat.beregnetBarnebidragPeriodeListe[1].periode).isEqualTo(
                    ÅrMånedsperiode(
    ...
    private fun utførBeregningerOgEvaluerResultatBarnebidrag() {
        ...
        if (forventetExceptionBegrensetRevurderingBeregnetBidragErLavereEnnLøpendeBidrag) {
        ...
        } else if (forventetExceptionBegrensetRevurderingLøpendeForskuddMangler) {
