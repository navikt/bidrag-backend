...
internal class BeregnAldersjusteringTest : FellesTest() {
    ...
    @Test
    @DisplayName("Aldersjustering - eksempel 12 - aldersjustert beløp er lavere enn løpende beløp - skal ikke kaste exception")
    ...
    fun testAldersjustering_Eksempel13() {
        // TODO Testfilen er fjernet fordi den inneholdt sensitive opplysninger. Det må opprettes en ny hvis denne testen skal kjøres.
    ...
    private fun utførBeregningerOgEvaluerResultatAldersjustering() {
        ...
        if (forventetExceptionAldersjusteringErLavereEnnLøpendeBidrag) {
        ...
        assertAll(
            ...
            { assertThat(sjablonSjablontallListe[0].periode).isEqualTo(ÅrMånedsperiode(YearMonth.parse("2024-07"), YearMonth.parse("2025-07"))) },
            ...
            { assertThat(sjablonSjablontallListe[1].periode).isEqualTo(ÅrMånedsperiode(YearMonth.parse("2024-07"), YearMonth.parse("2025-07"))) },
            ...
            { assertThat(sjablonForbruksutgifter[0].periode).isEqualTo(ÅrMånedsperiode(YearMonth.parse("2024-07"), YearMonth.parse("2025-07"))) },
            ...
            { assertThat(sjablonSamværsfradrag).hasSize(forventetAntallSjablonerSamværsfradrag) },
            {
                if (sjablonSamværsfradrag.isNotEmpty()) {
                    assertThat(sjablonSamværsfradrag[0].periode).isEqualTo(ÅrMånedsperiode(YearMonth.parse("2024-07"), YearMonth.parse("2025-07")))
                }
            },
            {
                if (sjablonSamværsfradrag.isNotEmpty()) {
    ...
    private fun lesFilOgByggRequestAldersjustering(filnavn: String): BeregnGrunnlagAldersjustering {
        ...
        // Lag request
        return commonObjectmapper.readValue(json, BeregnGrunnlagAldersjustering::class.java)
    }
}
