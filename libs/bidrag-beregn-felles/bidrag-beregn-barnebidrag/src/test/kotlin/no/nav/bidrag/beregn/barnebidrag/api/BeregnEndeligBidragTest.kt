...
internal class BeregnEndeligBidragTest : FellesTest() {
    ...
    fun testEndeligBidrag_Eksempel5() {
        ...
        forventetBeregnetBeløp = BigDecimal.valueOf(2828.20).setScale(2)
        forventetResultatbeløp = BigDecimal.valueOf(2830).setScale(0)
        forventetUMinusNettoBarnetilleggBM = BigDecimal.valueOf(990.00).setScale(2)
        forventetBruttoBidragEtterBarnetilleggBM = BigDecimal.valueOf(3990.00).setScale(2)
        forventetNettoBidragEtterBarnetilleggBM = BigDecimal.valueOf(990.00).setScale(2)
        ...
        forventetBruttoBidragEtterBarnetilleggBP = BigDecimal.valueOf(5828.20).setScale(2)
        forventetNettoBidragEtterSamværsfradrag = BigDecimal.valueOf(2828.20).setScale(2)
        forventetBpAndelAvUVedDeltBostedFaktor = BigDecimal.ZERO.setScale(10)
        forventetBpAndelAvUVedDeltBostedBeløp = BigDecimal.ZERO.setScale(2)
    ...
    fun testEndeligBidrag_Eksempel6() {
        ...
        forventetUMinusNettoBarnetilleggBM = BigDecimal.valueOf(990.00).setScale(2)
        forventetBruttoBidragEtterBarnetilleggBM = BigDecimal.valueOf(1989.00).setScale(2)
        forventetNettoBidragEtterBarnetilleggBM = BigDecimal.valueOf(990.00).setScale(2)
    ...
    fun testEndeligBidrag_Eksempel8A() {
        ...
        forventetBeregnetBeløp = BigDecimal.valueOf(990.00).setScale(2)
        forventetResultatbeløp = BigDecimal.valueOf(990).setScale(0)
        forventetUMinusNettoBarnetilleggBM = BigDecimal.valueOf(990.00).setScale(2)
        forventetBruttoBidragEtterBarnetilleggBM = BigDecimal.valueOf(1889.00).setScale(2)
        forventetNettoBidragEtterBarnetilleggBM = BigDecimal.valueOf(990.00).setScale(2)
        forventetBruttoBidragJustertForEvneOg25Prosent = BigDecimal.valueOf(1889.00).setScale(2)
        forventetBruttoBidragEtterBegrensetRevurdering = BigDecimal.valueOf(1889.00).setScale(2)
        forventetBruttoBidragEtterBarnetilleggBP = BigDecimal.valueOf(1889.00).setScale(2)
        forventetNettoBidragEtterSamværsfradrag = BigDecimal.valueOf(990.00).setScale(2)
        forventetBpAndelAvUVedDeltBostedFaktor = BigDecimal.ZERO.setScale(10)
        forventetBpAndelAvUVedDeltBostedBeløp = BigDecimal.ZERO.setScale(2)
        forventetBidragJustertForNettoBarnetilleggBM = true
        utførBeregningerOgEvaluerResultatEndeligBidrag()
    ...
    fun testEndeligBidrag_Eksempel9() {
        ...
        forventetUMinusNettoBarnetilleggBM = BigDecimal.valueOf(8514.80).setScale(2)
    ...
    fun testEndeligBidrag_Eksempel10D() {
        ...
        forventetBeregnetBeløp = BigDecimal.valueOf(4829.20).setScale(2)
        forventetResultatbeløp = BigDecimal.valueOf(4830).setScale(0)
        forventetUMinusNettoBarnetilleggBM = BigDecimal.valueOf(8514.80).setScale(2)
        forventetBruttoBidragEtterBarnetilleggBM = BigDecimal.valueOf(6000).setScale(2)
        forventetNettoBidragEtterBarnetilleggBM = BigDecimal.valueOf(5001).setScale(2)
        forventetBruttoBidragJustertForEvneOg25Prosent = BigDecimal.valueOf(6000).setScale(2)
        forventetBruttoBidragEtterBegrensetRevurdering = BigDecimal.valueOf(5499).setScale(2)
        forventetBruttoBidragEtterBarnetilleggBP = BigDecimal.valueOf(5828.20).setScale(2)
        forventetNettoBidragEtterSamværsfradrag = BigDecimal.valueOf(4829.20).setScale(2)
        forventetBpAndelAvUVedDeltBostedFaktor = BigDecimal.ZERO.setScale(10)
        forventetBpAndelAvUVedDeltBostedBeløp = BigDecimal.ZERO.setScale(2)
        forventetLøpendeForskudd = BigDecimal.valueOf(4500).setScale(0)
        forventetLøpendeBidrag = BigDecimal.valueOf(4000).setScale(0)
    ...
    fun testEndeligBidrag_Eksempel10K() {
        ...
        forventetBeregnetBeløp = BigDecimal.valueOf(745.40).setScale(2)
        ...
        forventetBruttoBidragEtterBarnetilleggBP = BigDecimal.valueOf(1744.40).setScale(2)
        forventetNettoBidragEtterSamværsfradrag = BigDecimal.valueOf(745.40).setScale(2)
        forventetBpAndelAvUVedDeltBostedFaktor = BigDecimal.ZERO.setScale(10)
        forventetBpAndelAvUVedDeltBostedBeløp = BigDecimal.ZERO.setScale(2)
    ...
    fun testEndeligBidrag_Eksempel_Flere_perioder() {
        ...
        forventetAntallBarnetilleggBM = 4
    ...
    private fun utførBeregningerOgEvaluerResultatEndeligBidragFlerePerioder() {
        ...
        assertAll(
            ...
            { assertThat(endeligBidragResultatListe[1].beregnetBeløp).isEqualTo(BigDecimal.valueOf(4755.80).setScale(2)) },
            { assertThat(endeligBidragResultatListe[1].resultatBeløp).isEqualTo(BigDecimal.valueOf(4760).setScale(0)) },
            { assertThat(endeligBidragResultatListe[1].uMinusNettoBarnetilleggBM).isEqualTo(BigDecimal.valueOf(4755.80).setScale(2)) },
            { assertThat(endeligBidragResultatListe[1].bruttoBidragEtterBarnetilleggBM).isEqualTo(BigDecimal.valueOf(5754.80).setScale(2)) },
            { assertThat(endeligBidragResultatListe[1].nettoBidragEtterBarnetilleggBM).isEqualTo(BigDecimal.valueOf(4755.80).setScale(2)) },
            { assertThat(endeligBidragResultatListe[1].bruttoBidragJustertForEvneOg25Prosent).isEqualTo(BigDecimal.valueOf(5754.80).setScale(2)) },
            { assertThat(endeligBidragResultatListe[1].bruttoBidragEtterBegrensetRevurdering).isEqualTo(BigDecimal.valueOf(5754.80).setScale(2)) },
            { assertThat(endeligBidragResultatListe[1].bruttoBidragEtterBarnetilleggBP).isEqualTo(BigDecimal.valueOf(5754.80).setScale(2)) },
            { assertThat(endeligBidragResultatListe[1].nettoBidragEtterSamværsfradrag).isEqualTo(BigDecimal.valueOf(4755.80).setScale(2)) },
            ...
            // Bidrag redusert til evne
            { assertThat(endeligBidragResultatListe[2].periode).isEqualTo(ÅrMånedsperiode("2023-06", "2023-07")) },
            ...
            { assertThat(endeligBidragResultatListe[2].uMinusNettoBarnetilleggBM).isEqualTo(BigDecimal.valueOf(4755.80).setScale(2)) },
            { assertThat(endeligBidragResultatListe[2].bruttoBidragEtterBarnetilleggBM).isEqualTo(BigDecimal.valueOf(5654.80).setScale(2)) },
            { assertThat(endeligBidragResultatListe[2].nettoBidragEtterBarnetilleggBM).isEqualTo(BigDecimal.valueOf(4755.80).setScale(2)) },
            ...
            // Bidrag redusert til evne
            { assertThat(endeligBidragResultatListe[3].periode).isEqualTo(ÅrMånedsperiode("2023-07", "2023-10")) },
            ...
            { assertThat(endeligBidragResultatListe[3].uMinusNettoBarnetilleggBM).isEqualTo(BigDecimal.valueOf(4367.00).setScale(2)) },
            { assertThat(endeligBidragResultatListe[3].bruttoBidragEtterBarnetilleggBM).isEqualTo(BigDecimal.valueOf(5266.00).setScale(2)) },
            { assertThat(endeligBidragResultatListe[3].nettoBidragEtterBarnetilleggBM).isEqualTo(BigDecimal.valueOf(4367.00).setScale(2)) },
            ...
            { assertThat(endeligBidragResultatListe[3].bidragJustertNedTilEvne).isTrue },
            { assertThat(endeligBidragResultatListe[3].bidragJustertNedTil25ProsentAvInntekt).isFalse },
            ...
            { assertThat(endeligBidragResultatListe[4].periode).isEqualTo(ÅrMånedsperiode("2023-10", "2024-01")) },
            { assertThat(endeligBidragResultatListe[4].beregnetBeløp).isEqualTo(BigDecimal.valueOf(2601).setScale(2)) },
            { assertThat(endeligBidragResultatListe[4].resultatBeløp).isEqualTo(BigDecimal.valueOf(2600).setScale(0)) },
            { assertThat(endeligBidragResultatListe[4].uMinusNettoBarnetilleggBM).isEqualTo(BigDecimal.valueOf(4367.00).setScale(2)) },
            { assertThat(endeligBidragResultatListe[4].bruttoBidragEtterBarnetilleggBM).isEqualTo(BigDecimal.valueOf(5266.00).setScale(2)) },
            { assertThat(endeligBidragResultatListe[4].nettoBidragEtterBarnetilleggBM).isEqualTo(BigDecimal.valueOf(4367.00).setScale(2)) },
            { assertThat(endeligBidragResultatListe[4].bruttoBidragJustertForEvneOg25Prosent).isEqualTo(BigDecimal.valueOf(3500).setScale(2)) },
            { assertThat(endeligBidragResultatListe[4].bruttoBidragEtterBegrensetRevurdering).isEqualTo(BigDecimal.valueOf(3500).setScale(2)) },
            { assertThat(endeligBidragResultatListe[4].bruttoBidragEtterBarnetilleggBP).isEqualTo(BigDecimal.valueOf(3500).setScale(2)) },
            { assertThat(endeligBidragResultatListe[4].nettoBidragEtterSamværsfradrag).isEqualTo(BigDecimal.valueOf(2601).setScale(2)) },
            ...
            { assertThat(endeligBidragResultatListe[4].bidragJustertForDeltBosted).isFalse },
            { assertThat(endeligBidragResultatListe[4].bidragJustertForNettoBarnetilleggBP).isFalse },
            { assertThat(endeligBidragResultatListe[4].bidragJustertForNettoBarnetilleggBM).isTrue },
            { assertThat(endeligBidragResultatListe[4].bidragJustertNedTilEvne).isFalse },
            { assertThat(endeligBidragResultatListe[4].bidragJustertNedTil25ProsentAvInntekt).isTrue },
            ...
            // Delt bosted
            { assertThat(endeligBidragResultatListe[5].periode).isEqualTo(ÅrMånedsperiode("2024-01", "2024-02")) },
            { assertThat(endeligBidragResultatListe[5].beregnetBeløp).isEqualTo(BigDecimal.ZERO.setScale(2)) },
            { assertThat(endeligBidragResultatListe[5].resultatBeløp).isEqualTo(BigDecimal.ZERO.setScale(0)) },
            { assertThat(endeligBidragResultatListe[5].uMinusNettoBarnetilleggBM).isEqualTo(BigDecimal.ZERO.setScale(2)) },
            { assertThat(endeligBidragResultatListe[5].bruttoBidragEtterBarnetilleggBM).isEqualTo(BigDecimal.ZERO.setScale(2)) },
            { assertThat(endeligBidragResultatListe[5].nettoBidragEtterBarnetilleggBM).isEqualTo(BigDecimal.ZERO.setScale(2)) },
            { assertThat(endeligBidragResultatListe[5].bruttoBidragJustertForEvneOg25Prosent).isEqualTo(BigDecimal.ZERO.setScale(2)) },
            { assertThat(endeligBidragResultatListe[5].bruttoBidragEtterBegrensetRevurdering).isEqualTo(BigDecimal.ZERO.setScale(2)) },
            { assertThat(endeligBidragResultatListe[5].bruttoBidragEtterBarnetilleggBP).isEqualTo(BigDecimal.ZERO.setScale(2)) },
            { assertThat(endeligBidragResultatListe[5].nettoBidragEtterSamværsfradrag).isEqualTo(BigDecimal.ZERO.setScale(2)) },
            ...
            { assertThat(endeligBidragResultatListe[5].bidragJustertForDeltBosted).isTrue },
            ...
            { assertThat(endeligBidragResultatListe[5].bidragJustertNedTil25ProsentAvInntekt).isFalse },
            ...
            // Bidrag redusert til 25% av inntekt
            { assertThat(endeligBidragResultatListe[6].periode).isEqualTo(ÅrMånedsperiode("2024-02", "2024-05")) },
            { assertThat(endeligBidragResultatListe[6].beregnetBeløp).isEqualTo(BigDecimal.valueOf(2601).setScale(2)) },
            { assertThat(endeligBidragResultatListe[6].resultatBeløp).isEqualTo(BigDecimal.valueOf(2600).setScale(0)) },
            { assertThat(endeligBidragResultatListe[6].uMinusNettoBarnetilleggBM).isEqualTo(BigDecimal.valueOf(15390.00).setScale(2)) },
            { assertThat(endeligBidragResultatListe[6].bruttoBidragEtterBarnetilleggBM).isEqualTo(BigDecimal.valueOf(12000).setScale(2)) },
            { assertThat(endeligBidragResultatListe[6].nettoBidragEtterBarnetilleggBM).isEqualTo(BigDecimal.valueOf(11101).setScale(2)) },
            { assertThat(endeligBidragResultatListe[6].bruttoBidragJustertForEvneOg25Prosent).isEqualTo(BigDecimal.valueOf(3500).setScale(2)) },
            { assertThat(endeligBidragResultatListe[6].bruttoBidragEtterBegrensetRevurdering).isEqualTo(BigDecimal.valueOf(3500).setScale(2)) },
            { assertThat(endeligBidragResultatListe[6].bruttoBidragEtterBarnetilleggBP).isEqualTo(BigDecimal.valueOf(3500).setScale(2)) },
            { assertThat(endeligBidragResultatListe[6].nettoBidragEtterSamværsfradrag).isEqualTo(BigDecimal.valueOf(2601).setScale(2)) },
            { assertThat(endeligBidragResultatListe[6].bpAndelAvUVedDeltBostedFaktor).isEqualTo(BigDecimal.ZERO.setScale(10)) },
            { assertThat(endeligBidragResultatListe[6].bpAndelAvUVedDeltBostedBeløp).isEqualTo(BigDecimal.ZERO.setScale(2)) },
            ...
            { assertThat(endeligBidragResultatListe[6].bidragJustertForDeltBosted).isFalse },
            ...
            { assertThat(endeligBidragResultatListe[6].bidragJustertNedTil25ProsentAvInntekt).isTrue },
            ...
            // Delt bosted
            { assertThat(endeligBidragResultatListe[7].periode).isEqualTo(ÅrMånedsperiode("2024-05", "2024-07")) },
            { assertThat(endeligBidragResultatListe[7].beregnetBeløp).isEqualTo(BigDecimal.valueOf(2000).setScale(2)) },
            { assertThat(endeligBidragResultatListe[7].resultatBeløp).isEqualTo(BigDecimal.valueOf(2000).setScale(0)) },
            ...
            { assertThat(endeligBidragResultatListe[7].bruttoBidragJustertForEvneOg25Prosent).isEqualTo(BigDecimal.valueOf(2000).setScale(2)) },
            ...
            { assertThat(endeligBidragResultatListe[7].nettoBidragEtterSamværsfradrag).isEqualTo(BigDecimal.valueOf(2000).setScale(2)) },
            { assertThat(endeligBidragResultatListe[7].bpAndelAvUVedDeltBostedFaktor).isEqualTo(BigDecimal.valueOf(0.1).setScale(10)) },
            { assertThat(endeligBidragResultatListe[7].bpAndelAvUVedDeltBostedBeløp).isEqualTo(BigDecimal.valueOf(2000).setScale(2)) },
            ...
            { assertThat(endeligBidragResultatListe[7].ikkeOmsorgForBarnet).isFalse },

            // Delt bosted
            { assertThat(endeligBidragResultatListe[8].periode).isEqualTo(ÅrMånedsperiode("2024-07", "2024-08")) },
            { assertThat(endeligBidragResultatListe[8].beregnetBeløp).isNull() },
            { assertThat(endeligBidragResultatListe[8].resultatBeløp).isNull() },
            ...
            { assertThat(endeligBidragResultatListe[8].bruttoBidragJustertForEvneOg25Prosent).isEqualTo(BigDecimal.ZERO.setScale(2)) },
            ...
            { assertThat(endeligBidragResultatListe[8].nettoBidragEtterSamværsfradrag).isEqualTo(BigDecimal.ZERO.setScale(2)) },
            { assertThat(endeligBidragResultatListe[8].bpAndelAvUVedDeltBostedFaktor).isEqualTo(BigDecimal.ZERO.setScale(10)) },
            { assertThat(endeligBidragResultatListe[8].bpAndelAvUVedDeltBostedBeløp).isEqualTo(BigDecimal.ZERO.setScale(2)) },
            ...
            { assertThat(endeligBidragResultatListe[8].bidragJustertForDeltBosted).isFalse },
            ...
            { assertThat(endeligBidragResultatListe[8].ikkeOmsorgForBarnet).isTrue },

            // Delt bosted
            { assertThat(endeligBidragResultatListe[9].periode).isEqualTo(ÅrMånedsperiode(YearMonth.parse("2024-08"), null)) },
            { assertThat(endeligBidragResultatListe[9].beregnetBeløp).isEqualTo(BigDecimal.valueOf(1000).setScale(2)) },
            { assertThat(endeligBidragResultatListe[9].resultatBeløp).isEqualTo(BigDecimal.valueOf(1000).setScale(0)) },
            { assertThat(endeligBidragResultatListe[9].uMinusNettoBarnetilleggBM).isEqualTo(BigDecimal.ZERO.setScale(2)) },
            { assertThat(endeligBidragResultatListe[9].bruttoBidragEtterBarnetilleggBM).isEqualTo(BigDecimal.ZERO.setScale(2)) },
            { assertThat(endeligBidragResultatListe[9].nettoBidragEtterBarnetilleggBM).isEqualTo(BigDecimal.ZERO.setScale(2)) },
            { assertThat(endeligBidragResultatListe[9].bruttoBidragJustertForEvneOg25Prosent).isEqualTo(BigDecimal.valueOf(1000).setScale(2)) },
            { assertThat(endeligBidragResultatListe[9].bruttoBidragEtterBegrensetRevurdering).isEqualTo(BigDecimal.ZERO.setScale(2)) },
            { assertThat(endeligBidragResultatListe[9].bruttoBidragEtterBarnetilleggBP).isEqualTo(BigDecimal.ZERO.setScale(2)) },
            { assertThat(endeligBidragResultatListe[9].nettoBidragEtterSamværsfradrag).isEqualTo(BigDecimal.valueOf(1000).setScale(2)) },
            { assertThat(endeligBidragResultatListe[9].bpAndelAvUVedDeltBostedFaktor).isEqualTo(BigDecimal.valueOf(0.1).setScale(10)) },
            { assertThat(endeligBidragResultatListe[9].bpAndelAvUVedDeltBostedBeløp).isEqualTo(BigDecimal.valueOf(1000).setScale(2)) },
            { assertThat(endeligBidragResultatListe[9].løpendeForskudd).isNull() },
            { assertThat(endeligBidragResultatListe[9].løpendeBidrag).isNull() },
            { assertThat(endeligBidragResultatListe[9].barnetErSelvforsørget).isFalse },
            { assertThat(endeligBidragResultatListe[9].bidragJustertForDeltBosted).isTrue },
            { assertThat(endeligBidragResultatListe[9].bidragJustertForNettoBarnetilleggBP).isFalse },
            { assertThat(endeligBidragResultatListe[9].bidragJustertForNettoBarnetilleggBM).isFalse },
            { assertThat(endeligBidragResultatListe[9].bidragJustertNedTilEvne).isFalse },
            { assertThat(endeligBidragResultatListe[9].bidragJustertNedTil25ProsentAvInntekt).isFalse },
            { assertThat(endeligBidragResultatListe[9].bidragJustertTilForskuddssats).isFalse },
            { assertThat(endeligBidragResultatListe[9].begrensetRevurderingUtført).isFalse },
            { assertThat(endeligBidragResultatListe[9].ikkeOmsorgForBarnet).isFalse },
    ...
    private fun utførBeregningerOgEvaluerResultatEndeligBidragFlerePerioderBegrensetRevurdering() {
        ...
        assertAll(
            ...
            { assertThat(endeligBidragResultatListe[0].uMinusNettoBarnetilleggBM).isEqualTo(BigDecimal.valueOf(8514.80).setScale(2)) },
            ...
            { assertThat(endeligBidragResultatListe[1].uMinusNettoBarnetilleggBM).isEqualTo(BigDecimal.valueOf(8514.80).setScale(2)) },
            ...
            { assertThat(endeligBidragResultatListe[2].uMinusNettoBarnetilleggBM).isEqualTo(BigDecimal.valueOf(8514.80).setScale(2)) },
