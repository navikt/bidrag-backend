...
class BeregnGebyrServiceTest {
    ...
    fun `skal beregne med manuelt overstyrt gebyr`() {
        ...
        resultat.finnGrunnlagSomErReferertAv(Grunnlagstype.SJABLON_SJABLONTALL, sluttberegning.grunnlag) shouldHaveSize 2
    ...
    fun `skal legge til grunnlag sjablon`() {
        ...
        nedreInntektsgrenseGebyrSjablon.innhold.verdi shouldBe BigDecimal(354600)

        val fastsettelsegebyrSjablon = sjablonGrunnlag.find { it.innhold.sjablon == SjablonTallNavn.FASTSETTELSESGEBYR_BELØP }!!
        fastsettelsegebyrSjablon.innhold.verdi shouldBe BigDecimal(1345)
    }
}
