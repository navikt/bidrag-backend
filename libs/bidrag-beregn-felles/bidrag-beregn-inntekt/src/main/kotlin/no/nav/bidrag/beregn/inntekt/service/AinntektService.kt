...
import no.nav.bidrag.beregn.inntekt.util.InntektUtil.Companion.KEY_3MND_OV
import no.nav.bidrag.beregn.inntekt.util.InntektUtil.Companion.PERIODE_MÅNED
import no.nav.bidrag.beregn.inntekt.util.InntektUtil.Companion.PERIODE_ÅR
            ...
            ainntektMap.forEach {
                ...
                ainntektListeUt.add(
                    SummertÅrsinntekt(
                        ...
                        sumInntekt =
                        when {
                            it.key.startsWith(KEY_3MND) -> it.value.sumInntekt.multiply(BigDecimal.valueOf(4))

                            // Regner om til årsinntekt
