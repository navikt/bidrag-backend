...
class TestUtil {
    companion object {
        inline fun <reified T> fileToObject(path: String): T {
            ...
            return commonObjectmapper.readValue(jsonString, T::class.java)
        }
        ...
        fun byggBarnetilleggPensjon2() = listOf(
            // barn 1
            Barnetillegg(
                periodeFra = LocalDate.parse("2025-11-01"),
                periodeTil = LocalDate.parse("2026-01-01"),
                beløp = BigDecimal.valueOf(7500),
                barnPersonId = "98765432109",
            ),
            Barnetillegg(
                periodeFra = LocalDate.parse("2026-01-01"),
                periodeTil = LocalDate.parse("2026-02-01"),
                beløp = BigDecimal.valueOf(7500),
                barnPersonId = "98765432109",
            ),
            // barn 2
        ...
        fun byggInntektRequest(filnavn: String) = commonObjectmapper.readValue(File(filnavn), TransformerInntekterRequest::class.java)
    }
}
