...
internal class BoforholdBarnServiceV3 {
    ...
    private fun beregnPerioderForBarn(
        ...
        if (boforholdRequest.endreBostatus == null) {
            if (behandledeOpplysninger.isNotEmpty()) {
                ...
                val komplettOffentligTidslinje =
                    fyllUtMedPerioderBarnetIkkeBorIHusstanden(startdatoBeregning = startdatoBeregning, liste = justerteOffentligePerioder)
        ...
        val komplettOffentligTidslinje = fyllUtMedPerioderBarnetIkkeBorIHusstanden(
            startdatoBeregning = startdatoBeregning,
            liste = justerteOffentligePerioder,
        )
        val offentligePerioderJustertMotAttenårsdag =
            justerMotAttenårsdag(attenårFraDato, typeBehandling, boforholdRequest.erSøknadsbarn, komplettOffentligTidslinje)
