package no.nav.bidrag.beregn.boforhold

import no.nav.bidrag.beregn.boforhold.dto.BoforholdBarnRequest
import no.nav.bidrag.beregn.boforhold.dto.BoforholdBarnRequestV3
import no.nav.bidrag.beregn.boforhold.dto.BoforholdResponse
...
import no.nav.bidrag.beregn.boforhold.response.BoforholdBeregnet
import no.nav.bidrag.beregn.boforhold.response.RelatertPerson
import no.nav.bidrag.beregn.boforhold.service.BoforholdAndreVoksneService
import no.nav.bidrag.beregn.boforhold.service.BoforholdBarnServiceV2
import no.nav.bidrag.beregn.boforhold.service.BoforholdBarnServiceV3
import no.nav.bidrag.beregn.boforhold.service.BoforholdServiceV1
