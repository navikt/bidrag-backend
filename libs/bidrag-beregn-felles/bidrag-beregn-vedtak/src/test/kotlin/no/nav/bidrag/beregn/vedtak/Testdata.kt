...
val ba1 = Testperson("Født Først", Personident(genererFødselsnummer(LocalDate.now().minusYears(13))), LocalDate.now().minusYears(13), Rolletype.BARN)
val ba2 = Testperson("Den Yngste", Personident(genererFødselsnummer(LocalDate.now().minusYears(3))), LocalDate.now().minusYears(3), Rolletype.BARN)
