...
@Service
class BidragSakConsumer(@Value("\${BIDRAG_SAK_URL}") val url: URI, @Qualifier("azure") private val restTemplate: RestOperations) :
    ...
    @BrukerCacheable(CacheConfig.Companion.SAK_CACHE)
