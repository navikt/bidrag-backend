...
internal class ForskuddCoreMapperTest {
    ...
    fun mapPersonUgyldig() {
        val innholdSøknadsbarn = innholdSøknadsbarnMedFeil()
        val innholdBidragsmottaker = innholdBidragsmottakerOK()
    ...
    fun mapBostatusPeriodeUgyldig() {
        val innholdSøknadsbarn = innholdSøknadsbarnOK()
        val innholdBidragsmottaker = innholdBidragsmottakerOK()
        val innholdBostatusMedFeil = innholdBostatusMedFeil()
        val beregnForskuddGrunnlag =
            BeregnGrunnlag(
                periode = ÅrMånedsperiode(fom = "2020-12", til = "2021-01"),
                søknadsbarnReferanse = "Person_Søknadsbarn",
    ...
    fun mapInntektPeriodeUgyldig() {
        val innholdSøknadsbarn = innholdSøknadsbarnOK()
        val innholdBidragsmottaker = innholdBidragsmottakerOK()
        val innholdBostatus = innholdBostatusOK()
        val innholdInntektMedFeil = innholdInntektMedFeil()
        val beregnForskuddGrunnlag =
            BeregnGrunnlag(
                periode = ÅrMånedsperiode(fom = "2020-12", til = "2021-01"),
                søknadsbarnReferanse = "Person_Søknadsbarn",
    ...
    fun mapSivilstandPeriodeUgyldig() {
        ...
        val innholdBidragsmottaker = innholdBidragsmottakerOK()
        val innholdBostatus = innholdBostatusOK()
        val innholdInntekt = innholdInntektOK()
        val innholdSivilstandMedFeil = innholdSivilstandMedFeil()
        val beregnForskuddGrunnlag =
            BeregnGrunnlag(
                periode = ÅrMånedsperiode(fom = "2020-12", til = "2021-01"),
                søknadsbarnReferanse = "Person_Søknadsbarn",
    ...
    private fun innholdSøknadsbarnMedFeil() = commonObjectmapper.readTree("{\"ident\": \"${genererFødselsnummer()}\"," + "\"navn\": \"Søknadsbarn\"," + "\"fødselsdato\": null}")

    private fun innholdSøknadsbarnOK() = commonObjectmapper.readTree("{\"ident\": \"11111111111\"," + "\"navn\": \"Søknadsbarn\"," + "\"fødselsdato\": \"2010-01-01\"}")

    private fun innholdBidragsmottakerOK() = commonObjectmapper.readTree("{\"ident\": \"11111111111\"," + "\"navn\": \"Bidragsmottaker\"," + "\"fødselsdato\": \"1982-01-01\"}")

    private fun innholdBostatusMedFeil() = commonObjectmapper.readTree(
        "{\"periode\":{" + "\"fom\": \"2020-12\"," + "\"til\": \"2021-01\"}," + "\"bostatus\": \"MED_BESTEMOR\"," +
            "\"manueltRegistrert\": false}",
    )

    private fun innholdBostatusOK() = commonObjectmapper.readTree(
        "{\"periode\":{" + "\"fom\": \"2020-12\"," + "\"til\": \"2021-01\"}," + "\"bostatus\": \"MED_FORELDER\"," +
            "\"manueltRegistrert\": false, \"relatertTilPart\": \"Person_Bidragsmottaker\"}",
    )

    private fun innholdInntektMedFeil() = commonObjectmapper.readTree(
    ...
    private fun innholdInntektOK() = commonObjectmapper.readTree(
        "{\"periode\":{" + "\"fom\": \"2020-12\"," + "\"til\": \"2021-01\"}," + "\"inntektsrapportering\": \"AINNTEKT\"," +
            "\"gjelderBarn\": null," + "\"beløp\": 290000," + "\"manueltRegistrert\": false," + "\"valgt\": true}",
    )

    private fun innholdSivilstandMedFeil() = commonObjectmapper.readTree("{\"periode\":{" + "\"fom\": \"2020-12\"," + "\"til\": \"2021-01\"}," + "\"sivilstand\": \"UGIFT\"}")
}
