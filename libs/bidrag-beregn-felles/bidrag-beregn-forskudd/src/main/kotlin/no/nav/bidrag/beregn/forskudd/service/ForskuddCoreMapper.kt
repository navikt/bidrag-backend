...
internal object ForskuddCoreMapper : CoreMapper() {
    ...
    private fun mapBostatus(beregnForskuddGrunnlag: BeregnGrunnlag): List<BostatusPeriodeCore> {
        try {
            val bostatusGrunnlag = if (beregnForskuddGrunnlag.grunnlagListe
                    .filtrerBasertPåFremmedReferanse(Grunnlagstype.BOSTATUS_PERIODE).all { it.gjelderBarnReferanse == null }
            ) {
