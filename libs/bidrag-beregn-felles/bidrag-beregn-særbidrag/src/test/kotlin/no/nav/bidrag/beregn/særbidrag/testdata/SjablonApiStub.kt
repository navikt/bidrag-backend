...
class SjablonApiStub {
    ...
    private fun settOppSjablonSjablontallStub() {
        ...
        } returns commonObjectmapper.readValue(sjablonliste, object : TypeReference<List<Sjablontall>>() {})
    }
    ...
    private fun settOppSjablonBidragsevneStub() {
        ...
        } returns commonObjectmapper.readValue(sjablonliste, object : TypeReference<List<Bidragsevne>>() {})
    }
    ...
    private fun settOppSjablonSamværsfradragStub() {
        ...
        } returns commonObjectmapper.readValue(sjablonliste, object : TypeReference<List<Samværsfradrag>>() {})
    }
    ...
    private fun settOppSjablonTrinnvisSkattesatsStub() {
        ...
        } returns commonObjectmapper.readValue(sjablonliste, object : TypeReference<List<TrinnvisSkattesats>>() {})
    }
}
