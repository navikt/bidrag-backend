...
internal class BeregnSærbidragApiTest {
    ...
    @Mock
    var mockBPsBeregnedeTotalbidragBeregning: BPsBeregnedeTotalbidragBeregning? = Mockito.mock(BPsBeregnedeTotalbidragBeregning::class.java)
    ...
    fun skalKalleCoreOgReturnereEtResultat_særbidrag_eksempel_inntekt_skjønn_mangler_dokumentasjon() {
        ...
        val delberegningSumInntektBPResultat =
            commonObjectmapper.treeToValue(delberegningSumInntektBPListe[0].innhold, DelberegningSumInntekt::class.java)
    ...
    fun testAtReduksjonUnderholdskostnadIkkeKanVæreUnder0() {
        ...
        val bPsBeregnedeTotalbidragResultat = totalSærbidragResultat.grunnlagListe
            ...
            .map { commonObjectmapper.treeToValue(it.innhold, DelberegningBidragspliktigesBeregnedeTotalbidrag::class.java) }
            .first()
    ...
    private fun utførBeregningerOgEvaluerResultat() {
        ...
        val bidragsevneResultat = commonObjectmapper.treeToValue(delberegningBidragsevneListe[0].innhold, DelberegningBidragsevne::class.java)
        ...
        val bPAndelSærbidragResultat =
            commonObjectmapper.treeToValue(delberegningBPAndelSærbidragListe[0].innhold, DelberegningBidragspliktigesAndel::class.java)
        ...
        val sluttberegningSærbidragResultat =
            commonObjectmapper.treeToValue(sluttberegningSærbidragListe[0].innhold, SluttberegningSærbidrag::class.java)
        ...
        val delberegningSumInntektBMResultat =
            commonObjectmapper.treeToValue(delberegningSumInntektBMListe[0].innhold, DelberegningSumInntekt::class.java)

        val delberegningSumInntektSBListe = totalSærbidragResultat.grunnlagListe
            .filter { it.type == Grunnlagstype.DELBEREGNING_SUM_INNTEKT }
            .filter { it.gjelderReferanse == referanseSB }
        val delberegningSumInntektSBResultat =
            commonObjectmapper.treeToValue(delberegningSumInntektSBListe[0].innhold, DelberegningSumInntekt::class.java)
        ...
        val delberegningBarnIHusstandResultat =
            commonObjectmapper.treeToValue(delberegningBarnIHusstandListe[0].innhold, DelberegningBarnIHusstand::class.java)
        ...
        val delberegningVoksneIHusstandResultat =
            commonObjectmapper.treeToValue(delberegningVoksneIHusstandListe[0].innhold, DelberegningVoksneIHusstand::class.java)
        ...
        val delberegningBoforholdResultat =
            commonObjectmapper.treeToValue(delberegningBoforholdListe[0].innhold, DelberegningBoforhold::class.java)
    ...
    private fun lesFilOgByggRequest(filnavn: String): BeregnGrunnlag {
        ...
        // Erstatt placeholder-tokens med genererte fødselsnummer
        json = json.replace("{FNR_SB}", genererFødselsnummer())
        json = json.replace("{FNR_BM}", genererFødselsnummer())
        json = json.replace("{FNR_BP}", genererFødselsnummer())
        ...
        json = json.replace("{FNR_BABP}", genererFødselsnummer())

        // Lag request
        return commonObjectmapper.readValue(json, BeregnGrunnlag::class.java)
    }
}
