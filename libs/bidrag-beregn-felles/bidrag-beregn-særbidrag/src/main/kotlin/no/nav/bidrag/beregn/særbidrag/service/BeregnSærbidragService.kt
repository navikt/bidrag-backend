...
internal class BeregnSærbidragService(
    ...
    fun beregn(grunnlag: BeregnGrunnlag, vedtakstype: Vedtakstype): BeregnetSærbidragResultat {
        secureLogger.debug { "Særbidragberegning - følgende request mottatt: ${commonObjectmapper.writeValueAsString(grunnlag)}" }
    ...
    fun validerValutakode(løpendeBidragGrunnlag: LøpendeBidragGrunnlag): Boolean = løpendeBidragGrunnlag.løpendeBidragListe.all { it.valutakode == "NOK" }
    ...
    private fun utførDelberegninger(
        ...
        secureLogger.debug { "Særbidragberegning - returnerer følgende respons: ${commonObjectmapper.writeValueAsString(respons)}" }
    ...
    private fun beregnBidragsevne(bidragsevneGrunnlagTilCore: BeregnBidragsevneGrunnlagCore): BeregnBidragsevneResultatCore {
        secureLogger.debug { "Bidragsevne - grunnlag for beregning: ${commonObjectmapper.writeValueAsString(bidragsevneGrunnlagTilCore)}" }
        ...
        secureLogger.debug {
            "Bidragsevne - resultat av beregning: ${commonObjectmapper.writeValueAsString(bidragsevneResultatFraCore.resultatPeriodeListe)}"
        }
    ...
    private fun beregnBPsBeregnedeTotalbidrag(løpendeBidragGrunnlagCore: LøpendeBidragGrunnlagCore): BeregnBPsBeregnedeTotalbidragResultatCore {
        secureLogger.debug {
            "BPs Beregnede Totalbidrag - grunnlag for beregning: ${commonObjectmapper.writeValueAsString(løpendeBidragGrunnlagCore)}"
        }
        ...
        secureLogger.debug {
            "BPs Beregnede Totalbidrag - resultat av beregning: ${
                commonObjectmapper.writeValueAsString(
                    bPsBeregnedeTotalbidragResultatFraCore.resultatPeriode,
                )
            }"
        }
    ...
    private fun beregnBPAndelSærbidrag(bpAndelSærbidragGrunnlagTilCore: BeregnBPsAndelSærbidragGrunnlagCore): BeregnBPsAndelSærbidragResultatCore {
        secureLogger.debug {
            "BP's andel av særbidrag - grunnlag for beregning: ${
                commonObjectmapper.writeValueAsString(
                    bpAndelSærbidragGrunnlagTilCore,
                )
            }"
        }
        ...
        secureLogger.debug {
            "BPs andel av særbidrag - resultat av beregning: ${commonObjectmapper.writeValueAsString(
                bpAndelSærbidragResultatFraCore.resultatPeriodeListe,
            )}"
        }
    ...
    private fun beregnSærbidrag(særbidragGrunnlagTilCore: BeregnSærbidragGrunnlagCore): BeregnSærbidragResultatCore {
        secureLogger.debug { "Særbidrag - grunnlag for beregning: ${commonObjectmapper.writeValueAsString(særbidragGrunnlagTilCore)}" }
        ...
        secureLogger.debug {
            "Særbidrag - resultat av beregning: ${commonObjectmapper.writeValueAsString(særbidragResultatFraCore.resultatPeriodeListe)}"
        }
    ...
    private fun lagGrunnlagslisteBidragsevne(
        ...
        val sumAntallBarnListe = grunnlagTilCore.barnIHusstandenPeriodeListe
            .filter { barnIHusstanden -> boforholdListe.flatMap { it.grunnlagsreferanseListe }.contains(barnIHusstanden.referanse) }
        val voksneIHusstandenListe = grunnlagTilCore.voksneIHusstandenPeriodeListe
            .filter { voksneIHusstanden -> boforholdListe.flatMap { it.grunnlagsreferanseListe }.contains(voksneIHusstanden.referanse) }
