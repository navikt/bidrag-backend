...
internal class BeregnApiTest {
    ...
    fun skalBeregneInntekt() {
        ...
        val fnrBarn1 = genererFødselsnummer()
        val fnrBarn2 = genererFødselsnummer()
        val request = lesFilOgByggRequest(filnavn, fnrBarn1, fnrBarn2)
        ...
        assertAll(
            ...
            { assertThat(inntektResultat.inntektPerBarnListe[0].inntektGjelderBarn).isNull() },
            ...
            { assertThat(inntektResultat.inntektPerBarnListe[1].inntektGjelderBarn!!.ident.toString()).isEqualTo(fnrBarn1) },
            ...
            { assertThat(inntektResultat.inntektPerBarnListe[2].inntektGjelderBarn!!.ident.toString()).isEqualTo(fnrBarn2) },
    ...
    private fun lesFilOgByggRequest(filnavn: String?, fnrBarn1: String, fnrBarn2: String): BeregnValgteInntekterGrunnlag {
        var json = ""
        ...
        json = json.replace("{FNR_BARN1}", fnrBarn1)
        json = json.replace("{FNR_BARN2}", fnrBarn2)

        // Lag request
        return commonObjectmapper.readValue(json, BeregnValgteInntekterGrunnlag::class.java)
    }
}
