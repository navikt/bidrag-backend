...
//            resultat3.size shouldBe 6
    ...
    fun `Test 1a, 1c, 2a endreSivilstand = null behandledeSivilstandsopplysninger er utfyllt og innhentedeOffentligeOpplysninger er utfyllt`() {
        ...
        assertSoftly {
            ...
            resultat3[2].periodeTom shouldBe LocalDate.of(2023, 11, 30)
            resultat3[2].sivilstandskode shouldBe Sivilstandskode.BOR_ALENE_MED_BARN
            resultat3[2].kilde shouldBe Kilde.OFFENTLIG

            resultat3[3].periodeFom shouldBe LocalDate.of(2023, 12, 1)
            resultat3[3].periodeTom shouldBe null
            resultat3[3].sivilstandskode shouldBe Sivilstandskode.GIFT_SAMBOER
            resultat3[3].kilde shouldBe Kilde.OFFENTLIG
//
...
//            resultat3[4].kilde shouldBe Kilde.OFFENTLIG
    ...
    @Test
    fun `Test at inaktiv periode med start etter aktiv periode ignoreres`() {
        sivilstandServiceV2 = SivilstandServiceV2()
        val mottattSivilstand = TestUtil.testInaktivPeriodeEtterAktivPeriode()

        val virkningstidspunkt1 = LocalDate.of(2010, 11, 1)
        val resultat = sivilstandServiceV2.beregn(virkningstidspunkt1, mottattSivilstand)
        ...
        assertSoftly {
            ...
            resultat[0].periodeFom shouldBe LocalDate.of(2010, 11, 1)
            resultat[0].periodeTom shouldBe LocalDate.of(2014, 6, 30)
            resultat[0].sivilstandskode shouldBe Sivilstandskode.UKJENT
            resultat[0].kilde shouldBe Kilde.OFFENTLIG

            resultat[1].periodeFom shouldBe LocalDate.of(2014, 7, 1)
            resultat[1].periodeTom shouldBe LocalDate.of(2014, 7, 31)
            resultat[1].sivilstandskode shouldBe Sivilstandskode.BOR_ALENE_MED_BARN
            resultat[1].kilde shouldBe Kilde.OFFENTLIG

            resultat[2].periodeFom shouldBe LocalDate.of(2014, 8, 1)
            resultat[2].periodeTom shouldBe null
            resultat[2].sivilstandskode shouldBe Sivilstandskode.GIFT_SAMBOER
            resultat[2].kilde shouldBe Kilde.OFFENTLIG
        }
    ...
    @Test
    fun `Test beregning uten offentlig periode og så med`() {
        sivilstandServiceV2 = SivilstandServiceV2()
        val utenOffentligPeriode = TestUtil.testUtenOgSåMedOffentligPeriode()[0]
        val medOffentligPeriode = TestUtil.testUtenOgSåMedOffentligPeriode()[1]

        val virkningstidspunkt = LocalDate.of(2026, 2, 1)
        val resultatUtenOffentligPeriode = sivilstandServiceV2.beregn(virkningstidspunkt, utenOffentligPeriode)
        val resultatMedOffentligPeriode = sivilstandServiceV2.beregn(virkningstidspunkt, medOffentligPeriode)
        assertSoftly {
            Assertions.assertNotNull(resultatUtenOffentligPeriode)
            Assertions.assertNotNull(resultatMedOffentligPeriode)

            resultatUtenOffentligPeriode.shouldHaveSize(1)
            resultatUtenOffentligPeriode[0].periodeFom shouldBe LocalDate.of(2026, 2, 1)
            resultatUtenOffentligPeriode[0].periodeTom shouldBe null
            resultatUtenOffentligPeriode[0].sivilstandskode shouldBe Sivilstandskode.UKJENT
            resultatUtenOffentligPeriode[0].kilde shouldBe Kilde.OFFENTLIG

            resultatMedOffentligPeriode.shouldHaveSize(1)
            resultatMedOffentligPeriode[0].periodeFom shouldBe LocalDate.of(2026, 2, 1)
            resultatMedOffentligPeriode[0].periodeTom shouldBe null
            resultatMedOffentligPeriode[0].sivilstandskode shouldBe Sivilstandskode.BOR_ALENE_MED_BARN
            resultatMedOffentligPeriode[0].kilde shouldBe Kilde.OFFENTLIG
        }
    }
}
