...
class TestUtil {
    companion object {
        ...
        fun testInaktivPeriodeEtterAktivPeriode() = SivilstandRequest(
            fødselsdatoBM = LocalDate.parse("1980-01-01"),
            innhentedeOffentligeOpplysninger =
            listOf(
                SivilstandGrunnlagDto(
                    personId = "55555",
                    type = SivilstandskodePDL.GIFT,
                    gyldigFom = LocalDate.of(2014, 7, 4),
                    bekreftelsesdato = null,
                    master = "PDL",
                    registrert = LocalDateTime.parse("2020-12-05T14:44:16"),
                    historisk = true,
                ...
                SivilstandGrunnlagDto(
                    ...
                    bekreftelsesdato = null,
                    master = "PDL",
                    registrert = LocalDateTime.parse("2020-07-10T14:44:16"),
                    historisk = false,
                ),
                SivilstandGrunnlagDto(
                    personId = "55555",
                    type = SivilstandskodePDL.SEPARERT,
                    gyldigFom = LocalDate.of(2020, 5, 19),
                    bekreftelsesdato = null,
                    master = "PDL",
                    registrert = LocalDateTime.parse("2020-07-09T14:44:16"),
                    historisk = true,
                ),
                SivilstandGrunnlagDto(
                    personId = "55555",
                    type = SivilstandskodePDL.GJENLEVENDE_PARTNER,
                    gyldigFom = LocalDate.of(2014, 7, 3),
                    bekreftelsesdato = null,
                    master = "PDL",
                    registrert = LocalDateTime.parse("2020-12-05T14:44:16"),
                    historisk = true,
                ...
                SivilstandGrunnlagDto(
                    personId = "55555",
                    type = SivilstandskodePDL.SKILT,
                    gyldigFom = LocalDate.of(2023, 2, 17),
                    bekreftelsesdato = null,
                    master = "PDL",
                    registrert = LocalDateTime.parse("2021-07-09T14:44:16"),
                    historisk = true,
                ),
            ),
            behandledeSivilstandsopplysninger = emptyList(),
        ...
        fun testUtenOgSåMedOffentligPeriode() = listOf(
            SivilstandRequest(
                fødselsdatoBM = LocalDate.parse("1980-01-01"),
                innhentedeOffentligeOpplysninger = emptyList(),
                behandledeSivilstandsopplysninger = emptyList(),
            ...
            SivilstandRequest(
                ...
                listOf(
                    Sivilstand(
                        periodeFom = LocalDate.of(2026, 2, 1),
                        periodeTom = null,
                        sivilstandskode = Sivilstandskode.UKJENT,
                        kilde = Kilde.OFFENTLIG,
                    ),
