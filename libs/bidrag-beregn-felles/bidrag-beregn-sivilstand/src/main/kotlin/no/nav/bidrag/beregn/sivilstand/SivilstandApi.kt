...
class SivilstandApi {
    companion object {
        ...
        fun beregnV1(virkningstidspunkt: LocalDate, sivilstandGrunnlagDtoListe: List<SivilstandGrunnlagDto>): SivilstandBeregnet = serviceV1.beregn(virkningstidspunkt, sivilstandGrunnlagDtoListe)
        private val serviceV2 = SivilstandServiceV2()
        fun beregnV2(virkningstidspunkt: LocalDate, sivilstandRequest: SivilstandRequest): List<Sivilstand> = serviceV2.beregn(virkningstidspunkt, sivilstandRequest)
    }
}
