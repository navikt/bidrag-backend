...
//    private val baseUrl = "https://oppgave.intern.dev.nav.no"
    ...
    private fun getRestClient(): RestClient = RestClient.builder()
        .baseUrl(baseUrl)
    ...
    private fun bearerTokenInterceptor(): ClientHttpRequestInterceptor = ClientHttpRequestInterceptor { request: HttpRequest, body: ByteArray?, execution: ClientHttpRequestExecution ->
